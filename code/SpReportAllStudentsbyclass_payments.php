...
$formnameheaderforprint = "Class list - Payments";
?>
<!doctype html>
<html lang="en">
...
<body>
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    <table>
      <form method="POST" action="SpReportAllStudentsbyclass_payments.php">
      ...
      <form action="exporttoexcelbyclass_payments.php" method="post">
