...
<html lang="en">
  ...
  ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
      <table>
        <form method="POST" action="SpReportAllStudentsbyclass_religion.php">
...
<form action="exporttoexcelbyreligion.php" method="post">					
      ...
      <div id="printableArea" class="box-body" style="font-family:'Droid Arabic Naskh', serif;">
        ...
        ?>
          ...
          while ($row   = mysqli_fetch_array($CheckIfHereInF)) {
            ...
            $SqlCommandForCFe2 = " SELECT `Id_Student`, `StudentName`, `Dateofbirth`, `Nationality`, `Religion`, `IndexNo` FROM `student` where `IndexNo` = '$studentindex' order by StudentName   ";
