...
$formname  = "termsheetstudentpartial.php";
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="box-body" style="font-family:'Droid Arabic Naskh', serif;">
      ...
      if (isset($_POST['tree'])) {
        ...
        $link = "<script>
          window.open('termsheetstudentprintallpartial.php?csyear=" . $csyear . "&syear=" . $syear . "','_blank',
          'toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=800, height=800')
          </script>";
        echo $link;

        header("refresh:1;url=termsheetstudentpartial.php");
        die();
      }
      ?>
        ...
        ?>
          ...
          <table id="myTable" class="table table-striped table-sm">
            ...
            <tbody>
              ...
              <tr>
                <td colspan="3">Parent's Signature </td>
              </tr>
              <tr>
                <td colspan="3"> <br /></td>
              </tr>
              <tr>
                <td colspan="3">1st term ____________________________________________________________</td>
              </tr>
              <tr>
                <td colspan="3"> <br /></td>
              </tr>
              <tr>
                <td colspan="3">2nd term ____________________________________________________________</td>
              </tr>
              <tr>
                <td colspan="3"> <br /></td>
              </tr>
              <tr>
                <td colspan="3">3rd term ____________________________________________________________</td>
              </tr>
              <tr>
                <td colspan="3"> <br /></td>
              </tr>
