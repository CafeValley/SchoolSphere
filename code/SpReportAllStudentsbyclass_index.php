...
$formnameheaderforprint = "Class list - Index";
?>
<!doctype html>
<html lang="en">
  ...
  ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
      <table>
        <form method="POST" action="SpReportAllStudentsbyclass_index.php">
...
<form action="exporttoexcelbyindex.php" method="post">					
        ...
        ?>
          ...
          while ($row   = mysqli_fetch_array($CheckIfHereInF)) {
            ...
            $studentindex = $row['studentindex'];
             ...
             $SqlCommandForCFe2 = " SELECT  `StudentName`,`IndexNo` FROM `student` where 
          ...
          <table id="myTable" class="table table-striped table-sm">
            <thead>
              <tr>
                ...
                <th onclick="sortTable(2)">Index No</th>
              </tr>
            </thead>
            <tbody>
              <?php
