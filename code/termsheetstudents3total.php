...
$formname  = "termsheetstudents3total.php";
$formnameheaderforprint = "Third Term";
          ...
          <table id="myTable" class="table table-striped table-sm">
            <thead>
              <tr>
                ...
                <?php
                if ($souceofdata == 'register') {
                  $AllowToGetMark = (getsubjectslistregister3rd($grade, $subclassname));
                } else
                  $AllowToGetMark = (getsubjectslist3rd($grade, $subclassname));
                echo "<br>";
                $listofcodes = array();
                ...
                if ($souceofdata == 'register') {
                  $stndlist = getstnd3($grade, $subclassname, 'register');
                } else
                  $stndlist = getstnd3($grade, $subclassname);
                ?>
                ...
                ?>
                <th onclick="sortTableNumber(<?php echo $ordercount += 1; ?>)">Total</th>
            ...
            <tbody>
              ...
              while ($CheckIfReturnInF   = mysqli_fetch_array($CheckIfHereInF)) {
                ...
                echo "<td>";
                  ...
                  $numberofsubjects = 1;
             $z =(int)($totaldisplayed / $numberofsubjects);
             echo $z;
                echo "</td>";
                echo "<td>";
