...
<body>
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    <table>
      <form method="POST" action="SpReportAllStudentsbyclass_paid.php">
    ...
    <?php if (isset($_POST['yearforsubject'])) { ?>
      ...
      <form action="exporttoexcelbyclass_paid.php" method="post">
    ...
    <div id="printableArea" class="box-body" style="font-family:'Droid Arabic Naskh', serif;">
      ...
      <div class="table-responsive">
        ...
        if (isset($_POST['yearforsubject'])) {
          ...
          $SqlCommandForCFe = " SELECT `id`,`StudentName`, `studentindex`, `yearselect`, `subclassname`, `feesregis`,
          `feesyear`, `active`, `2ndactive` FROM `studentsregistered` , `student` WHERE `IndexNo` = `studentindex` and
          `yearselect` = '$yearselect' and `subclassname` = '$subclass' and studentsregistered.acadmicyear = '$Acadyear' and `2ndactive` = 0 order by
          `StudentName` ";
        ...
        ?>
          ...
          if ($rowcounthere > 0) {
              ...
              <table id="myTable" class="table table-striped table-sm">
                <thead>
                  <tr>
                    ...
                    <th onclick="sortTableNumber(2)">Paid</th>
                    <th onclick="sortTable(3)">Index No</th>
                  </tr>
                </thead>
                <tbody>
              <?php
            ...
            while ($CheckIfReturnInF2   = mysqli_fetch_array($CheckIfHereInF2)) {
              ...
              echo "  <td>" . $CheckIfReturnInF2['studentindex'] . "</td>";
              echo "</tr>";
            }
          }
              ?>
