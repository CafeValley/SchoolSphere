  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div id="printableArea" class="box-body" style="font-family:'Droid Arabic Naskh', serif;">
      ...
      <div class="table-responsive">
        ...
        $SqlCommandForCFe = " SELECT `Id_Student`, `StudentName`, `Dateofbirth`, `Nationality`, `Religion`, `IndexNo` , `phone1`, `phone2` FROM `student` where `acadmicyear` = '$Acadyear' order by StudentName  ";
