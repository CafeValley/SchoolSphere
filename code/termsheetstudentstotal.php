...
$formname  = "termsheetstudentstotal.php";
$formnameheaderforprint = "First Term";
          ...
          <table id="myTable" class="table table-striped table-sm">
            <thead>
              <tr>
                ...
                <?php
                if ($souceofdata == 'register') 
                  $AllowToGetMark = (getsubjectslistregister($grade, $subclassname));
                else
                  $AllowToGetMark = (getsubjectslistold($grade, $subclassname));
                echo "<br>";
                $listofcodes = array();
                ...
                if ($souceofdata == 'register') {
                  $stndlist = getstnd($grade, $subclassname, 'register');
                } else
