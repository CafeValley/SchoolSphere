  ...
  ?>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
      ...
      <div id="printableArea" class="box-body" style="font-family:'Droid Arabic Naskh', serif;">
        ...
        $SqlCommandForCFe = " SELECT `idfortable`, discountdata.regisid, `discountamount` , `StudentName` FROM `discountdata` , `student`,`studentsregistered` where studentsregistered.id = discountdata.regisid  and `studentindex` = `IndexNo` order by StudentName ";
          ...
          <table id="myTable" class="table table-striped table-sm">
            ...
            while ($CheckIfReturnInF   = mysqli_fetch_array($CheckIfHereInF)) {
              ...
              $discountamount = $CheckIfReturnInF['discountamount'];
               ...
               $sqlregis = "SELECT `id`, `studentindex`, `yearselect`, `subclassname`, `feesregis`, `feesyear`, `active`, `2ndactive`,studentsregistered.acadmicyear as acadmicyear, `StudentName` FROM `studentsregistered` , `student` where `id` = '$regisid'  and `studentindex` = `IndexNo` order by StudentName ";
