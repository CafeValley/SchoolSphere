...
<body onload="window.print();">
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="box-body" style="font-family:'Droid Arabic Naskh', serif;">
      ...
      $grade = $syear;
      $subclassname = $csyear;
      $SqlCommandForCFebig = " SELECT distinct(studentindex) as studentindex , StudentName FROM `marks_first_term` ,
      ...
      $CheckIfHereInFbig = mysqli_query($link, $SqlCommandForCFebig);
...
<footer class="text-left " >
  <!-- Grid container -->
    ...
    <section class="">
      ...
      <div class="col-6">
		      <strong class="d-inline-block mb-4">Headmaster's Signature </strong>
<br><br><br>
------------------------------
      </div>
