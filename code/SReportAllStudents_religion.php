...
$formnameheaderforprint = "All Students - Religion";
?>
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    <form method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      ...
      <select name="part" onchange='this.form.submit()'>
        ...
        ?>
              ...
              <option>Catholic Christian</option>
              <option>Non-Catholic Christian</option>
            <?php
            }
            break;
          case 'Muslim': {
              $mywhere = "where `Religion` ='Muslim'";
            ?>
              <option>All</option>
            ...
            break;
          case 'Christian': {
              $mywhere = "where `Religion` ='Christian'";
            ?>
              <option>All</option>
              <option>Muslim</option>
          ...
          case 'Catholic Christian': {
              $mywhere = "where `Religion` ='Catholic Christian'";
            ?>
              <option>All</option>
              <option>Muslim</option>
              <option>Christian</option>
              <option selected>Catholic Christian</option>
              <option>Non-Catholic Christian</option>
            <?php
            }
            break;
          case 'Non-Catholic Christian': {
              $mywhere = "where `Religion` ='Non-Catholic Christian'";
            ?>
              <option>All</option>
              <option>Muslim</option>
              <option>Christian</option>
              <option>Catholic Christian</option>
              <option selected>Non-Catholic Christian</option>
            <?php
            }
            break;
          default: {
    ...
    <div id="printableArea" class="box-body" style="font-family:'Droid Arabic Naskh', serif;">
      ...
      <div class="table-responsive">
        ...
        `acadmicyear` FROM `student` $mywhere order by StudentName ";
        ...
        <table id="myTable" class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th onclick="sortTable(2)">Religion</th>
