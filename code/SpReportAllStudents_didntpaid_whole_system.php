...
$formnameheaderforprint = "Class list - Reminder (All)";
?>
<!doctype html>
<html lang="en">
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    <div id="printableArea" class="box-body" style="font-family:'Droid Arabic Naskh', serif;">
      ...
      <div class="table-responsive">
        ...
        $SqlCommandForCFe = " SELECT DISTINCT(studentindex) as studentindex , `StudentName` FROM `studentsregisteredfees` , `student` where studentindex=IndexNo and `active1` = '1'  order by `StudentName`";
        ...
        <table id="myTable" class="table table-striped table-sm">
          ...
          <tbody>
            ...
            while ($CheckIfReturnInF   = mysqli_fetch_array($CheckIfHereInF)) {
              ...
              $SqlCommandForCFein = " SELECT yearselect,subclassname FROM `studentsregistered` where studentindex='$studnetindex' and `active` = '1' ";
