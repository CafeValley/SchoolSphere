...
$formname  = "termsheetstudent_avgpartial.php";
  ...
  <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="box-body" style="font-family:'Droid Arabic Naskh', serif;">
      ...
      if (isset($_POST['tree'])) {
        ...
        $link = "<script>
          window.open('termsheetstudent_avgprintallpartial.php?csyear=" . $csyear . "&syear=" . $syear . "','_blank',
          'toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=800, height=800')
          </script>";
        echo $link;

        header("refresh:1;url=termsheetstudent_avgpartial.php");
        die();
      }
      ?>
