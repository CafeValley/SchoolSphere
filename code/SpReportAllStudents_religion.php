...
$formnameheaderforprint = "Class list - Religion";
?>
      ...
      <select name="part" onchange='this.form.submit()'>
        ...
        ?>
          ...
          case 'Muslim': {
            ...
            break;
          case 'Christian': {
              $mywhere = "and `Religion` ='Christian'";
            ?>
              <option>All</option>
              <option>Muslim</option>
          ...
          case 'Catholic Christian': {
              $mywhere = "and `Religion` ='Catholic Christian'";
            ?>
              <option>All</option>
              <option>Muslim</option>
              <option>Christian</option>
          ...
          case 'Non-Catholic Christian': {
              $mywhere = "and `Religion` ='Non-Catholic Christian'";
            ?>
              <option>All</option>
              <option>Muslim</option>
              <option>Christian</option>
