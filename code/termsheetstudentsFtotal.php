...
$formname  = "termsheetstudentsFtotal.php";
          ...
          <table id="myTable" class="table table-striped table-sm">
            <thead>
              <tr>
                ...
                <?php
                if ($souceofdata == 'register') {
                  $AllowToGetMark = (getsubjectslistregisterFinal($grade, $subclassname));
                } else
                  $AllowToGetMark = (getsubjectslistfinal($grade, $subclassname));
                echo "<br>";
                $listofcodes = array();
                ...
                if ($souceofdata == 'register') {
                  $stndlist = getstndF($grade, $subclassname, 'register');
                } else
                  $stndlist = getstndF($grade, $subclassname);
                ?>
